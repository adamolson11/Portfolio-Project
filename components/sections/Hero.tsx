  ...
  return (
    <section id="hero" className="relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 py-20 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        >
          <span className="text-sky-400 text-sm">Hi, I'm Adam (New Ness)</span>
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2 mb-4 text-white">
            Learning web dev and IT, one project at a time.
          </h1>
          <p className="text-lg text-slate-300 max-w-2xl mb-6">
            I'm teaching myself web development, studying IT support, and building small tools to learn. I also write fiction and think about systems. Still figuring things out, but enjoying the process.
          </p>
          <div className="flex gap-3">
            <Link href="#projects" className="px-5 py-2 rounded-md bg-sky-500 text-white hover:bg-sky-400">See what I'm building</Link>
            <a href="#about" className="px-5 py-2 rounded-md border border-slate-700 text-slate-200 hover:bg-slate-800">More about me</a>
          </div>
